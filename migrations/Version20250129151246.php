 ...
 */
final class Version20250129151246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
      ...
      //  $this->addSql('ALTER TABLE product CHANGE rubric_id subrubric_id INT NOT NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD53D89DD2 FOREIGN KEY (rubric_id) REFERENCES rubric (id)');
        $this->addSql('CREATE INDEX IDX_D34A04AD53D89DD2 ON product (rubric_id)');
    }
