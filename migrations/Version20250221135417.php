 ...
 */
final class Version20250221135417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD53D89DD2 FOREIGN KEY (rubrics_id) REFERENCES rubric (id)');
