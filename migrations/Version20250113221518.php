 ...
 */
final class Version20250113221518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, product_id INT DEFAULT NULL, INDEX IDX_C53D045F4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `order_details` (quantity INT NOT NULL, price NUMERIC(10, 2) NOT NULL, product_id INT NOT NULL, order_id INT NOT NULL, INDEX IDX_845CA2C14584665A (product_id), INDEX IDX_845CA2C18D9F6D38 (order_id), PRIMARY KEY(product_id, order_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `orders` (id INT AUTO_INCREMENT NOT NULL, reference VARCHAR(50) NOT NULL, status VARCHAR(100) NOT NULL, payment_date DATETIME NOT NULL, payment_method VARCHAR(100) NOT NULL, total NUMERIC(10, 2) NOT NULL, document VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, date DATETIME NOT NULL, payment_status VARCHAR(50) NOT NULL, user_id INT NOT NULL, INDEX IDX_E52FFDEEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE rubric (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, parent_id INT DEFAULT NULL, INDEX IDX_60C4016C727ACA70 (parent_id), UNIQUE INDEX slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
