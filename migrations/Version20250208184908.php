 ...
 */
final class Version20250208184908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, note VARCHAR(255) NOT NULL, order_id INT DEFAULT NULL, INDEX IDX_3781EC108D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, product_id INT NOT NULL, INDEX IDX_C53D045F4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `order_details` (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, price NUMERIC(10, 2) NOT NULL, product_id INT NOT NULL, order_id INT NOT NULL, INDEX IDX_845CA2C14584665A (product_id), INDEX IDX_845CA2C18D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, reference VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, stock INT NOT NULL, is_available TINYINT(1) NOT NULL, weight NUMERIC(10, 2) NOT NULL, info_suppliers_id INT NOT NULL, rubric_id INT NOT NULL, tva_id INT NOT NULL, INDEX IDX_D34A04AD2E8878E4 (info_suppliers_id), INDEX IDX_D34A04ADA29EC0FC (rubric_id), INDEX IDX_D34A04AD4D79775F (tva_id), UNIQUE INDEX reference (reference), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE rubric (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, parent_id INT DEFAULT NULL, INDEX IDX_60C4016C727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD2E8878E4 FOREIGN KEY (info_suppliers_id) REFERENCES info_suppliers (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD2E8878E4');
