 ...
 */
final class Version20250101181105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, reference VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, weight NUMERIC(10, 2) NOT NULL, stock INT NOT NULL, is_available TINYINT(1) NOT NULL, suppliers_id INT NOT NULL, rubric_id INT DEFAULT NULL, tva_id INT NOT NULL, INDEX IDX_D34A04AD355AF43 (suppliers_id), INDEX IDX_D34A04ADA29EC0FC (rubric_id), INDEX IDX_D34A04AD4D79775F (tva_id), UNIQUE INDEX slug (slug), UNIQUE INDEX reference (reference), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE rubric (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, parent_id INT DEFAULT NULL, INDEX IDX_60C4016C727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE delivery ADD CONSTRAINT FK_3781EC10E636D3F5 FOREIGN KEY (ord_id) REFERENCES `orders` (id)');
